...
class ChatBot(object):
    ...
    def __init__(self,root):
         ...
         img_chat=Image.open('S:\All Somak Projects\All Programming Coding Projects\Full Stack HTML CSS IBM freecodecamp.org\Chat bot\Ask captain rounak.jpg')
         ...
         self.voice=Button(btn_frame,text="Help>>",command=self.voice,width=2,font=('arial',2,'bold'),fg='pink',bg='ORANGE')
         self.voice.grid(row=0,column=3,padx=5,sticky=W)
    ...
    def send(self):
        ...
        if  (self.entry.get()=='hello'):   
            ...
            self.text.insert(END,'\n\n'+ 'Bot:Machine learning is a subfield of artificial intelligence, which is broadly defined as the capability of a machine to imitate intelligent human behavior.' )     
